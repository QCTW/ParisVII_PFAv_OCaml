...
CAMLC = $(BIN_PATH)ocamlc
CAMLOPT = $(BIN_PATH)ocamlopt
CAMLDEP = $(BIN_PATH)ocamldep
CAMLLEX = $(BIN_PATH)ocamllex
CAMLYACC = $(BIN_PATH)ocamlyacc
...
include .depend
#OCAMLMAKEFILE = ~/git/mmottl-ocaml-makefile/OCamlMakefile
